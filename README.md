...
情绪粉碎机是一个纯 HTML、CSS、JavaScript 写成的本地优先小网页。它支持键盘输入和多语言语音输入，把临时想法、烦恼或碎碎念交给粉碎、燃烧、冲走、漂流瓶四种轻量动画处理。项目没有后端、没有账号、没有数据库。
